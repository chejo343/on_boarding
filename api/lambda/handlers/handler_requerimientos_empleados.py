from requerimientos_empleados_controller import RequerimientosEmpleadosController

def handle_requerimientos_empleados(method, body, param, query):
  controller = RequerimientosEmpleadosController()
  if method == 'POST':

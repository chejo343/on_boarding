...
class Responsable(db.Model, ModelBase):
  __tablename__ = 'OBTResponsable'

  IdResponsable = db.Column('IdResponsable', db.Integer, primary_key=True)
  ...
  def __repr__(self) -> str:
    return f'Id: {self.IdResponsable}'